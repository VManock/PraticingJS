...
if (numeralExercicio == 1) {
    ...
    else if (numeralExercicio == 2) {console.log(WIP)}
    else if (numeralExercicio == 3) {console.log(WIP)}
    else if (numeralExercicio == 4) {console.log(WIP)}
    else if (numeralExercicio == 5) {console.log(WIP)}
    else if (numeralExercicio != Number) {alert('Isso não é um número, por favor selecione um número')}
    else {alert("Erro! Reinicia a página")}
