...
if (numeralExercicio == 1) {
    var a = prompt("Você selecionou o exercicio 1, insira o valor de 'a'") 
    var b = prompt("Obrigado, agora insira o valor de 'b'") 
    var c = prompt("Obrigado, agora insira o valor de 'c'")
    comparaABC(a,b,c)
} 
...
function comparaABC (a,b,c) {
    ...
    if (a+b<c){ 
        return alert(a soma de a+b é (${a+b}) o que é menor que o valor de c (${c}))
    } else if ("a"+"b"=="c") {
        return alert(A soma de a (${a}) + b (${b}) é igual a c (${c}))
    } else {
        return alert("A soma de a + b foi maior que c.")
    }
